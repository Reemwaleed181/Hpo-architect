...
export function Button({ children, onClick, variant='neutral', className='' }:{ children: React.ReactNode, onClick?: ()=>void, variant?: 'neutral'|'primary'|'danger', className?:string }){
